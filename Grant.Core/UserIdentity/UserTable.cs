...
namespace AspNet.Identity.PostgreSQL
{
    ...
    public class UserTable<TUser> where TUser :IdentityUser
    {
        ...
        {
            string commandText = "SELECT dbo.\"UserName\" FROM \"AspNetUsers\" WHERE \"Id\" = @id";
        ...
        public string GetUserId(string userName)
        {
            ...
            string commandText = "SELECT \"Id\" FROM dbo.\"AspNetUsers\" WHERE LOWER(\"UserName\") = @name";
        ...
        {
            TUser user = null;
            string commandText = "SELECT * FROM dbo.\"AspNetUsers\" WHERE \"Id\" = @id";
            Dictionary<string, object> parameters = new Dictionary<string, object>() { { "@id", userId } };
        ...
        public List<TUser> GetUserByName(string userName)
        {
            ...
            string commandText = "SELECT * FROM dbo.\"AspNetUsers\" WHERE LOWER(\"UserName\") = @name";
            Dictionary<string, object> parameters = new Dictionary<string, object>() { { "@name", userName } };
        ...
        public List<TUser> GetUserByEmail(string email)
        {
            ...
            List<TUser> users = new List<TUser>();
            string commandText = "SELECT * FROM dbo.\"AspNetUsers\" WHERE LOWER(\"Email\") = @email";
        ...
        {
            string commandText = "SELECT \"PasswordHash\" FROM dbo.\"AspNetUsers\" WHERE \"Id\" = @id";
        ...
        {
            string commandText = "UPDATE dbo.\"AspNetUsers\" SET \"PasswordHash\" = @pwdHash WHERE \"Id\" = @id";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
        ...
        {
            string commandText = "SELECT \"SecurityStamp\" FROM dbo.\"AspNetUsers\" WHERE \"Id\" = @id";
            Dictionary<string, object> parameters = new Dictionary<string, object>() { { "@id", userId } };
        ...
        public int Insert(TUser user)
        {
            ...
            string commandText = @"
            INSERT INTO dbo.""AspNetUsers""(""Id"", ""UserName"", ""PasswordHash"", ""SecurityStamp"", ""Email"", 
                                        ""EmailConfirmed"")
        ...
        {
            string commandText = "DELETE FROM dbo.\"AspNetUsers\" WHERE \"Id\" = @userId";
            Dictionary<string, object> parameters = new Dictionary<string, object>();
